...
if __name__ == "__main__":
    ...
    base_output_dir = "unified_simulation_val/dec"
    ...
    for i in range(n_samples):
        # 随机 vx, ax, x0, y0
        x0 = float(np.random.uniform(1.0, 4.0))
        y0 = float(np.random.uniform(2.0, 10.0))
        vx = float(np.random.uniform(5.0, 15.0))
        ax = -5.0
        ...
        sim = ParabolaSimulator(
            ...
            vx=vx,
            ax=ax,
            newton_img_path='E:/dataset/newton/sign.png',
            fruit_img_path='E:/dataset/newton/bus3.png',
            newton_zoom=0.12,
            fruit_zoom=0.15,
            fixed_max_x=18,
            fixed_max_y=12,
