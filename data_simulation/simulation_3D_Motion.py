...
class SpatialSimulator:
    def __init__(self,
                 l0=3.0, dl=0.0,
                 s0=0.5, ds=0.0,
                 theta0=0.0, omega=0.0,
                 center0=(9, 6), vx=0.0, vy=0.0,
                 x_lim=(0, 18), y_lim=(0, 12),
    ...
    def render_frame(self, t):
        ...
        rect = Rectangle((-l/2, -s/2), width=l, height=s, color='purple')
...
if __name__ == "__main__":
    ...
    for i in range(n_samples):
        l0 = np.random.uniform(0.6, 0.8)
        dl = 1.6
        s0 = np.random.uniform(0.4, 0.5)
        ds = 1.6
        theta0 = 0.0
        omega = 0.0
        x0 = np.random.uniform(2.0, 9.0)
        y0 = np.random.uniform(7.0, 11.0)
        vx = np.random.uniform(4.0, 7.0)
