...
if __name__ == "__main__":
    ...
    "A small glass ball hanging from a cord, swinging like a normal pendulum. The fixed camera captures reflections and a smooth arc.",
    "A small metal sphere hanging from a string, performing regular pendulum swings. The fixed camera captures realistic motion and subtle shadow changes."
    ]
