...
if __name__ == "__main__":
    video_dir = "/home/yuan418/data/project/Newtongen_ICLR/physicsl_label/unified/clean_videos/acc"
    out_path = "physical_acc.pt"

    encoder = PhysicalEncoder(save_video=True, mask_outdir="masks/mask_videos_acc",
